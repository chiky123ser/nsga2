...
void realcross (NSGA2Type *nsga2Params,  individual *parent1, individual *parent2, individual *child1, individual *child2)
{
    ...
    if (randomperc() <= nsga2Params->pcross_real)
    {
        ...
        Cruc(parent1,parent2,child1,child2);
    
    }
    else
    {  // printf("in else realcross\n");
        
        copy_ind (nsga2Params,  parent1, child1);
        copy_ind (nsga2Params,  parent2, child2);        
        //Prints(child1,child2);
        
        //printf("out else realcross\n");
    }
    //printf("out realcross\n");
